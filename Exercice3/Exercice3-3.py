...
Objectif : Extraire les informations sur les produits de catégories différentes.

Consigne :
1. Choisissez plusieurs catégorie sur Amazon.
2. Récupérez les trois premières pages de résultats pour chaque catégories.
3. Extrayez pour chaque produit
-> Le nom du produit
-> Le prix
4. Affichez les ... premiers produits des trois premières pages et les enregistrer en csv.
